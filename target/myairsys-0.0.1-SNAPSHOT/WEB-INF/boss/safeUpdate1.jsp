    ...
    <div class="content">
            ...
            <div class="title2">
                <div class="title2-left">
                    ...
                    <div class="title2-left-right">
                        <div class="title2-left-right-1">${user.bName}</div>
                        <div class="title2-left-right-2"><span>账号</span><span class="user">${user.bossNumber }</span> </div>
                    </div>
                </div>
              </c:forEach>
            </div>
        ...
        <div class="bottom">
            ...
            <div class="bottom1">
                ...
                <div class="content1"></div>
                <div class="right1">
                   <a href="/airsys/xiupassword1">设置密码</a>
                </div>
            </div>
            <div class="bottom1">
                ...
                <div class="content1"></div>
                <div class="right1">
                    <a href="/airsys/xiupassword1">找回密码</a>
                </div>
            </div>
            <div class="bottom1">
