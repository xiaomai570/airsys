	...
	<div class="content">
		<div class="title1">
			<div class="title1-left">
				<img src="/airsys/assets/img/222.png"> <span class="right">改签查询</span>
			</div>
		</div>
		<div class="bottom">
			<form class="layui-form" action="/airsys/UpdateOrder">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="IdCard" lay-verify="title"
							autocomplete="off" placeholder="请输入身份证" class="layui-input">
					</div>
				</div>
