     ...
     <table class="table table-striped">
      ...
      <tr>      
         <td class="flightNumber">${ticketOrder.flightNumber}</td>
          ...
          <td class="grade">${ticketOrder.grade}</td>
          <td> ${ticketOrder.salesId}</td>
          <td><button class="button">改签</button></td>
         </tr>
      </c:forEach>
     </table>      
...
<script type="text/javascript">
       ...
       var IdCard=$(this).parent().parent("tr").children(".IdCard").html()
        var grade=$(this).parent().parent("tr").children(".grade").html()
       location.href="/airsys/UpdateOrder1?"+"flightNumber="+flightNumber+"&IdCard="+IdCard+"&grade="+grade
         })
