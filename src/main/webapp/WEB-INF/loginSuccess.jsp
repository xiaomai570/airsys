...
<body>
	...
	<div class="info">
		...
		<form action="/airsys/cexit" class="cexit" method="post">
			<input type="submit" value="安全退出" style="color: blue;">
		</form>
	</div>
		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show b">
				<div class="searchFlight">
					<div class="searchFlight-inner">
						<label class="l1">出发地</label> <input type="text" class="from_city"
							name="from_city"> <label class="l2">目的地</label> <input
							type="text" class="to_city" name="to_city"> <label
							class="l3">出发日期</label> <input type="date" class="start_date"
							name="start_date">
			...
			<div class="layui-tab-item">
				<form action="modify" method="post">
					<label class="l5">用户名</label> <input class="c_number" type="text"
