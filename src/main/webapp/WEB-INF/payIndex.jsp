...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="/airsys/alipay" method=get
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="text" value="飞机票" name="WIDsubject" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="text" value="${result}" name="WIDtotal_amount" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="text" value="寰宇国际公司为您服务" name="WIDbody" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
