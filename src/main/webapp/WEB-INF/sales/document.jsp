...
<body>
    ...
    <div class="bottom">
        ...
        <div class="bottom1">
            ...
            <div class="content1">${user.sumber}</div>
            <div class="right1">
                <a href="/airsys/xiupassword">修改密码</a>
            </div>
        </div>
        <div class="bottom1">
            <div class="left1">工号</div>
            <div class="content1">${user.jobId}</div>
            <div class="right1">
        ...
        <div class="bottom1">
            ...
            <div class="content1">${user.sname}</div>
            <div class="right1">

            </div>
        </div>
        <div class="bottom1">
            <div class="left1">所属营业点</div>
            <div class="content1">${user.sales}</div>
        </div>
        <div class="bottom1">
            <div class="left1">所在地址</div>
            <div class="content1">${user.address}</div>
            <div class="right1">
