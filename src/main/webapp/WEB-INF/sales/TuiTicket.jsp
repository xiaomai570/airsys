...
<div class="content">
    <div class="title1">
        <div class="title1-left">
            ...
            <span class="right">退票查询</span>
        </div>
    </div>
    <div class="bottom">
        <form class="layui-form" action="/airsys/SearchOrder">
            <div class="layui-form-item">
                <label class="layui-form-label">请输身份证</label>
                <div class="layui-input-block">
                    <input type="text" name="IdCard" lay-verify="title" autocomplete="off" placeholder="请输入身份证" class="layui-input">
                </div>
            </div>
            
           
            <div class="button">
                <input  class="button1" type="submit" name="search" value="查询">
            </div>
        </form>
    </div>
</div>
