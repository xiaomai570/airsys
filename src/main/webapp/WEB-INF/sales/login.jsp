...
<head>
    ...
    <style>
       body{
           background: url("/airsys/assets/img/timg.jpg")  ;
             ...
             <div class="bottom">
                 <form action="valid" method="post">
                     <div class="login_user">
                         <div class="one_icon"><img  src="/air_system/assets/img/user.png">
                      <div class="text" ><input class="t" type="text" name="user" value="账号"></div>
                         </div>
                     </div>
                     <div class="login_password">
                         <div class="icon"><img  src="/air_system/assets/img/password.png"></div>
