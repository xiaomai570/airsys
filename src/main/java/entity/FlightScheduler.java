...
public class FlightScheduler {
	...
	public FlightScheduler(int id, String flight_number, String start_date, String end_date, String from_city,
	...
	public String toString() {
	  return "[{'id':'" + id + "', 'flight_number':'" + flight_number + "', 'start_date':'" + start_date + "', 'end_date':'"
				+ end_date + "', 'from_city':'" + from_city + "', 'to_city':'" + to_city + "', 'departure_time':'" + departure_time
				+ "', 'arrival_time':'" + arrival_time + "', 'start_airplane':'" + start_airplane + "', 'end_airplane':'" + end_airplane + "'}]";
	}
}